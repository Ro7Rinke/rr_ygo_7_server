...
INSERT INTO "new_user_deck_cards" ("amount", "card_id", "created_at", "id", "slot", "updated_at", "user_deck_id") SELECT "amount", "card_id", "created_at", "id", "slot", "updated_at", "user_deck_id" FROM "user_deck_cards";
